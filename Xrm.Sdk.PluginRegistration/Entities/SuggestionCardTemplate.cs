...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class SuggestionCardTemplate : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_suggestioncardtemplate_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_suggestioncardtemplate_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_suggestioncardtemplate_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_suggestioncardtemplate_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_suggestioncardtemplate_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_suggestioncardtemplate_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_suggestioncardtemplate_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_suggestioncardtemplate_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_suggestioncardtemplate_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_suggestioncardtemplate_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_suggestioncardtemplate_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_suggestioncardtemplate_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Organization organization_suggestioncardtemplate
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("organization_suggestioncardtemplate", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency TransactionCurrency_suggestioncardtemplate
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("TransactionCurrency_suggestioncardtemplate", null);
			}
			set
			{
				this.OnPropertyChanging("TransactionCurrency_suggestioncardtemplate");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("TransactionCurrency_suggestioncardtemplate", null, value);
