...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class MonthlyFiscalCalendar : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation> MonthlyFiscalCalendar_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("MonthlyFiscalCalendar_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("MonthlyFiscalCalendar_AsyncOperations");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("MonthlyFiscalCalendar_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure> MonthlyFiscalCalendar_BulkDeleteFailures
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("MonthlyFiscalCalendar_BulkDeleteFailures", null);
			}
			set
			{
				this.OnPropertyChanging("MonthlyFiscalCalendar_BulkDeleteFailures");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("MonthlyFiscalCalendar_BulkDeleteFailures", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_monthlyfiscalcalendar_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_monthlyfiscalcalendar_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_monthlyfiscalcalendar_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_monthlyfiscalcalendar_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_monthlyfiscalcalendar_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_monthlyfiscalcalendar_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_monthlyfiscalcalendar_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_monthlyfiscalcalendar_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_monthlyfiscalcalendar_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_monthlyfiscalcalendar_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_monthlyfiscalcalendar_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_monthlyfiscalcalendar_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_monthlyfiscalcalendar_salespersonid
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_monthlyfiscalcalendar_salespersonid", null);
			}
			set
			{
				this.OnPropertyChanging("lk_monthlyfiscalcalendar_salespersonid");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_monthlyfiscalcalendar_salespersonid", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency transactioncurrency_monthlyfiscalcalendar
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("transactioncurrency_monthlyfiscalcalendar", null);
			}
			set
			{
				this.OnPropertyChanging("transactioncurrency_monthlyfiscalcalendar");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("transactioncurrency_monthlyfiscalcalendar", null, value);
