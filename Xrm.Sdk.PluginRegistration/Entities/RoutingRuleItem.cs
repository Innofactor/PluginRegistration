...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class RoutingRuleItem : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.Annotation> routingruleitem_Annotation
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.Annotation>("routingruleitem_Annotation", null);
			}
			set
			{
				this.OnPropertyChanging("routingruleitem_Annotation");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.Annotation>("routingruleitem_Annotation", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation> routingruleitem_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("routingruleitem_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("routingruleitem_AsyncOperations");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("routingruleitem_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure> routingruleitem_BulkDeleteFailures
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("routingruleitem_BulkDeleteFailures", null);
			}
			set
			{
				this.OnPropertyChanging("routingruleitem_BulkDeleteFailures");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("routingruleitem_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.ProcessSession> routingruleitem_ProcessSessions
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.ProcessSession>("routingruleitem_ProcessSessions", null);
			}
			set
			{
				this.OnPropertyChanging("routingruleitem_ProcessSessions");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.ProcessSession>("routingruleitem_ProcessSessions", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData> routingruleitem_userentityinstancedatas
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("routingruleitem_userentityinstancedatas", null);
			}
			set
			{
				this.OnPropertyChanging("routingruleitem_userentityinstancedatas");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("routingruleitem_userentityinstancedatas", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_RoutingRuleItem_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_RoutingRuleItem_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_routingruleitem_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingruleitem_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_routingruleitem_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingruleitem_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_routingruleitem_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingruleitem_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_routingruleitem_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingruleitem_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_routingruleitem_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingruleitem_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Organization organization_routingruleitems
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("organization_routingruleitems", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.Queue queue_routingruleitem
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Queue>("queue_routingruleitem", null);
			}
			set
			{
				this.OnPropertyChanging("queue_routingruleitem");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Queue>("queue_routingruleitem", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.RoutingRule routingrule_entries
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.RoutingRule>("routingrule_entries", null);
			}
			set
			{
				this.OnPropertyChanging("routingrule_entries");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.RoutingRule>("routingrule_entries", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Team team_routingruleitem
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Team>("team_routingruleitem", null);
			}
			set
			{
				this.OnPropertyChanging("team_routingruleitem");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Team>("team_routingruleitem", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency TransactionCurrency_routingruleitem
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("TransactionCurrency_routingruleitem", null);
			}
			set
			{
				this.OnPropertyChanging("TransactionCurrency_routingruleitem");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("TransactionCurrency_routingruleitem", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser user_routingruleitem
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("user_routingruleitem", null);
			}
			set
			{
				this.OnPropertyChanging("user_routingruleitem");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("user_routingruleitem", null, value);
