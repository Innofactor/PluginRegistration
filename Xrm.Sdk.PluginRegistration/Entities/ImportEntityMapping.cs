...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class ImportEntityMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Xrm.Sdk.PluginRegistration.Entities.ImportEntityMappingState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Xrm.Sdk.PluginRegistration.Entities.ImportEntityMappingState)(System.Enum.ToObject(typeof(Xrm.Sdk.PluginRegistration.Entities.ImportEntityMappingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData> userentityinstancedata_importentitymapping
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_importentitymapping", null);
			}
			set
			{
				this.OnPropertyChanging("userentityinstancedata_importentitymapping");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_importentitymapping", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.ImportMap ImportEntityMapping_ImportMap
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.ImportMap>("ImportEntityMapping_ImportMap", null);
			}
			set
			{
				this.OnPropertyChanging("ImportEntityMapping_ImportMap");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.ImportMap>("ImportEntityMapping_ImportMap", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_importentitymapping_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_importentitymapping_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_importentitymapping_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_importentitymapping_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_importentitymapping_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_importentitymapping_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_importentitymapping_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_importentitymapping_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_importentitymapping_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_importentitymapping_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_importentitymapping_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_importentitymapping_modifiedonbehalfby", null, value);
