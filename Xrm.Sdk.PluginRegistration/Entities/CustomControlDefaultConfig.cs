...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class CustomControlDefaultConfig : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Xrm.Sdk.PluginRegistration.Entities.Organization customcontroldefaultconfig_organization
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("customcontroldefaultconfig_organization", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_customcontroldefaultconfig_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_customcontroldefaultconfig_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_customcontroldefaultconfig_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_customcontroldefaultconfig_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_customcontroldefaultconfig_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_customcontroldefaultconfig_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_customcontroldefaultconfig_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_customcontroldefaultconfig_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_customcontroldefaultconfig_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_customcontroldefaultconfig_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_customcontroldefaultconfig_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_customcontroldefaultconfig_modifiedonbehalfby", null, value);
