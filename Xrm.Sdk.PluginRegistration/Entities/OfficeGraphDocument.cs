...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class OfficeGraphDocument : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_officegraphdocument_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_officegraphdocument_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_officegraphdocument_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_officegraphdocument_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_officegraphdocument_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_officegraphdocument_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_officegraphdocument_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_officegraphdocument_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Organization organization_officegraphdocument
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("organization_officegraphdocument", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency TransactionCurrency_officegraphdocument
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("TransactionCurrency_officegraphdocument", null);
			}
			set
			{
				this.OnPropertyChanging("TransactionCurrency_officegraphdocument");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("TransactionCurrency_officegraphdocument", null, value);
