...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class Privilege : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation> Privilege_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("Privilege_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("Privilege_AsyncOperations");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("Privilege_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure> Privilege_BulkDeleteFailures
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("Privilege_BulkDeleteFailures", null);
			}
			set
			{
				this.OnPropertyChanging("Privilege_BulkDeleteFailures");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("Privilege_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData> userentityinstancedata_privilege
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_privilege", null);
			}
			set
			{
				this.OnPropertyChanging("userentityinstancedata_privilege");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_privilege", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.ChannelAccessProfile> ChannelAccessProfile_Privilege
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.ChannelAccessProfile>("ChannelAccessProfile_Privilege", null);
			}
			set
			{
				this.OnPropertyChanging("ChannelAccessProfile_Privilege");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.ChannelAccessProfile>("ChannelAccessProfile_Privilege", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.Role> roleprivileges_association
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.Role>("roleprivileges_association", null);
			}
			set
			{
				this.OnPropertyChanging("roleprivileges_association");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.Role>("roleprivileges_association", null, value);
