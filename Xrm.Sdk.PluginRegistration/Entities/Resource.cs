...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class Resource : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation> Resource_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("Resource_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("Resource_AsyncOperations");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("Resource_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure> Resource_BulkDeleteFailures
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("Resource_BulkDeleteFailures", null);
			}
			set
			{
				this.OnPropertyChanging("Resource_BulkDeleteFailures");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("Resource_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.MailboxTrackingFolder> resource_MailboxTrackingFolders
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.MailboxTrackingFolder>("resource_MailboxTrackingFolders", null);
			}
			set
			{
				this.OnPropertyChanging("resource_MailboxTrackingFolders");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.MailboxTrackingFolder>("resource_MailboxTrackingFolders", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.PrincipalObjectAttributeAccess> resource_PrincipalObjectAttributeAccesses
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.PrincipalObjectAttributeAccess>("resource_PrincipalObjectAttributeAccesses", null);
			}
			set
			{
				this.OnPropertyChanging("resource_PrincipalObjectAttributeAccesses");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.PrincipalObjectAttributeAccess>("resource_PrincipalObjectAttributeAccesses", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.SyncError> Resource_SyncErrors
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.SyncError>("Resource_SyncErrors", null);
			}
			set
			{
				this.OnPropertyChanging("Resource_SyncErrors");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.SyncError>("Resource_SyncErrors", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData> userentityinstancedata_resource
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_resource", null);
			}
			set
			{
				this.OnPropertyChanging("userentityinstancedata_resource");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_resource", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.BusinessUnit business_unit_resources
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.BusinessUnit>("business_unit_resources", null);
			}
			set
			{
				this.OnPropertyChanging("business_unit_resources");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.BusinessUnit>("business_unit_resources", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Equipment equipment_resources
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Equipment>("equipment_resources", null);
			}
			set
			{
				this.OnPropertyChanging("equipment_resources");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Equipment>("equipment_resources", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Organization organization_resources
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("organization_resources", null);
			}
			set
			{
				this.OnPropertyChanging("organization_resources");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("organization_resources", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.ResourceSpec resourcespec_resources
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.ResourceSpec>("resourcespec_resources", null);
			}
			set
			{
				this.OnPropertyChanging("resourcespec_resources");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.ResourceSpec>("resourcespec_resources", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Site site_resources
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Site>("site_resources", null);
			}
			set
			{
				this.OnPropertyChanging("site_resources");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Site>("site_resources", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser systemuser_resources
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("systemuser_resources", null);
			}
			set
			{
				this.OnPropertyChanging("systemuser_resources");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("systemuser_resources", null, value);
