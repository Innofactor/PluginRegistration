...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class RecurrenceRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.RecurringAppointmentMaster> recurrencerule_recurringappointmentmaster
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.RecurringAppointmentMaster>("recurrencerule_recurringappointmentmaster", null);
			}
			set
			{
				this.OnPropertyChanging("recurrencerule_recurringappointmentmaster");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.RecurringAppointmentMaster>("recurrencerule_recurringappointmentmaster", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.ActivityPointer activity_pointer_recurrencerule
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.ActivityPointer>("activity_pointer_recurrencerule", null);
			}
			set
			{
				this.OnPropertyChanging("activity_pointer_recurrencerule");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.ActivityPointer>("activity_pointer_recurrencerule", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.BusinessUnit business_unit_recurrencerule
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.BusinessUnit>("business_unit_recurrencerule", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_recurrencerule_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_recurrencerule_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_recurrencerule_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_recurrencerule_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_recurrencerulebase_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_recurrencerulebase_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_recurrencerulebase_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_recurrencerulebase_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_recurrencerulebase_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_recurrencerulebase_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_recurrencerulebase_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_recurrencerulebase_modifiedonbehalfby", null, value);
