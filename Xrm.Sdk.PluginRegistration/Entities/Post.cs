...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class Post : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation> post_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("post_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("post_AsyncOperations");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("post_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure> post_BulkDeleteFailures
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("post_BulkDeleteFailures", null);
			}
			set
			{
				this.OnPropertyChanging("post_BulkDeleteFailures");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("post_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.PostComment> Post_Comments
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.PostComment>("Post_Comments", null);
			}
			set
			{
				this.OnPropertyChanging("Post_Comments");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.PostComment>("Post_Comments", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.PostLike> Post_Likes
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.PostLike>("Post_Likes", null);
			}
			set
			{
				this.OnPropertyChanging("Post_Likes");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.PostLike>("Post_Likes", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_post_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_post_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_post_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_post_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_post_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_post_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_post_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_post_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_post_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_post_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_post_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_post_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Organization organization_post
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("organization_post", null);
			}
		}
