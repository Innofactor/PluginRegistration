...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class RoutingRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Xrm.Sdk.PluginRegistration.Entities.RoutingRuleState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Xrm.Sdk.PluginRegistration.Entities.RoutingRuleState)(System.Enum.ToObject(typeof(Xrm.Sdk.PluginRegistration.Entities.RoutingRuleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.Annotation> routingrule_Annotation
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.Annotation>("routingrule_Annotation", null);
			}
			set
			{
				this.OnPropertyChanging("routingrule_Annotation");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.Annotation>("routingrule_Annotation", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation> routingrule_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("routingrule_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("routingrule_AsyncOperations");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("routingrule_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure> routingrule_BulkDeleteFailures
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("routingrule_BulkDeleteFailures", null);
			}
			set
			{
				this.OnPropertyChanging("routingrule_BulkDeleteFailures");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("routingrule_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.RoutingRuleItem> routingrule_entries
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.RoutingRuleItem>("routingrule_entries", null);
			}
			set
			{
				this.OnPropertyChanging("routingrule_entries");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.RoutingRuleItem>("routingrule_entries", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.ProcessSession> routingrule_ProcessSessions
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.ProcessSession>("routingrule_ProcessSessions", null);
			}
			set
			{
				this.OnPropertyChanging("routingrule_ProcessSessions");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.ProcessSession>("routingrule_ProcessSessions", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData> routingrule_userentityinstancedatas
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("routingrule_userentityinstancedatas", null);
			}
			set
			{
				this.OnPropertyChanging("routingrule_userentityinstancedatas");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("routingrule_userentityinstancedatas", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.BusinessUnit business_unit_routingrule
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.BusinessUnit>("business_unit_routingrule", null);
			}
			set
			{
				this.OnPropertyChanging("business_unit_routingrule");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.BusinessUnit>("business_unit_routingrule", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_routingrule_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingrule_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_routingrule_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingrule_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_routingrule_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingrule_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_routingrule_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingrule_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_routingrule_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingrule_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_routingrule_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_routingrule_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Organization organization_RoutingRules
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("organization_RoutingRules", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.Team team_routingrule
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Team>("team_routingrule", null);
			}
			set
			{
				this.OnPropertyChanging("team_routingrule");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Team>("team_routingrule", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency TransactionCurrency_Routingrule
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("TransactionCurrency_Routingrule", null);
			}
			set
			{
				this.OnPropertyChanging("TransactionCurrency_Routingrule");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("TransactionCurrency_Routingrule", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser user_routingrule
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("user_routingrule", null);
			}
			set
			{
				this.OnPropertyChanging("user_routingrule");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("user_routingrule", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Workflow Workflow_routingrule
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Workflow>("Workflow_routingrule", null);
			}
			set
			{
				this.OnPropertyChanging("Workflow_routingrule");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Workflow>("Workflow_routingrule", null, value);
