...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class PostComment : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_postcomment_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_postcomment_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_postcomment_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_postcomment_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_postcomment_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_postcomment_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Organization organization_PostComment
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("organization_PostComment", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.Post Post_Comments
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Post>("Post_Comments", null);
			}
			set
			{
				this.OnPropertyChanging("Post_Comments");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Post>("Post_Comments", null, value);
