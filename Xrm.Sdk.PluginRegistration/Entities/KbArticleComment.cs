...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class KbArticleComment : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation> KbArticleComment_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("KbArticleComment_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("KbArticleComment_AsyncOperations");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("KbArticleComment_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure> KbArticleComment_BulkDeleteFailures
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("KbArticleComment_BulkDeleteFailures", null);
			}
			set
			{
				this.OnPropertyChanging("KbArticleComment_BulkDeleteFailures");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("KbArticleComment_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.ProcessSession> KbArticleComment_ProcessSessions
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.ProcessSession>("KbArticleComment_ProcessSessions", null);
			}
			set
			{
				this.OnPropertyChanging("KbArticleComment_ProcessSessions");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.ProcessSession>("KbArticleComment_ProcessSessions", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData> userentityinstancedata_kbarticlecomment
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_kbarticlecomment", null);
			}
			set
			{
				this.OnPropertyChanging("userentityinstancedata_kbarticlecomment");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_kbarticlecomment", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.KbArticle kbarticle_comments
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.KbArticle>("kbarticle_comments", null);
			}
			set
			{
				this.OnPropertyChanging("kbarticle_comments");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.KbArticle>("kbarticle_comments", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_kbarticlecomment_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_kbarticlecomment_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_kbarticlecomment_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_kbarticlecomment_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_kbarticlecomment_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_kbarticlecomment_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_kbarticlecomment_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_kbarticlecomment_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_kbarticlecommentbase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_kbarticlecommentbase_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_kbarticlecommentbase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_kbarticlecommentbase_modifiedby", null);
			}
		}
