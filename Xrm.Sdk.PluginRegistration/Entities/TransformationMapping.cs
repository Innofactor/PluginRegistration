...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class TransformationMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Xrm.Sdk.PluginRegistration.Entities.TransformationMappingState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Xrm.Sdk.PluginRegistration.Entities.TransformationMappingState)(System.Enum.ToObject(typeof(Xrm.Sdk.PluginRegistration.Entities.TransformationMappingState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.TransformationParameterMapping> TransformationParameterMapping_TransformationMapping
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.TransformationParameterMapping>("TransformationParameterMapping_TransformationMapping", null);
			}
			set
			{
				this.OnPropertyChanging("TransformationParameterMapping_TransformationMapping");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.TransformationParameterMapping>("TransformationParameterMapping_TransformationMapping", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData> userentityinstancedata_transformationmapping
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_transformationmapping", null);
			}
			set
			{
				this.OnPropertyChanging("userentityinstancedata_transformationmapping");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_transformationmapping", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_transformationmapping_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_transformationmapping_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_transformationmapping_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_transformationmapping_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_transformationmapping_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_transformationmapping_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_transformationmapping_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_transformationmapping_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_transformationmapping_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_transformationmapping_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_transformationmapping_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_transformationmapping_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.ImportMap TransformationMapping_ImportMap
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.ImportMap>("TransformationMapping_ImportMap", null);
			}
			set
			{
				this.OnPropertyChanging("TransformationMapping_ImportMap");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.ImportMap>("TransformationMapping_ImportMap", null, value);
