...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class SLAItem : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.SyncError> SLAItem_SyncErrors
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.SyncError>("SLAItem_SyncErrors", null);
			}
			set
			{
				this.OnPropertyChanging("SLAItem_SyncErrors");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.SyncError>("SLAItem_SyncErrors", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_slaitembase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_slaitembase_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_slaitembase_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_slaitembase_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_slaitembase_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_slaitembase_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_slaitembase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_slaitembase_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_slaitembase_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_slaitembase_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_slaitembase_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_slaitembase_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SLA sla_slaitem_slaId
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SLA>("sla_slaitem_slaId", null);
			}
			set
			{
				this.OnPropertyChanging("sla_slaitem_slaId");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SLA>("sla_slaitem_slaId", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Workflow slaitembase_workflowid
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Workflow>("slaitembase_workflowid", null);
			}
			set
			{
				this.OnPropertyChanging("slaitembase_workflowid");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Workflow>("slaitembase_workflowid", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency TransactionCurrency_SLAItem
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.TransactionCurrency>("TransactionCurrency_SLAItem", null);
			}
		}
