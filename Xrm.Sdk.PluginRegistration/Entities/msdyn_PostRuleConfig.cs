...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class msdyn_PostRuleConfig : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Xrm.Sdk.PluginRegistration.Entities.msdyn_PostRuleConfigState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Xrm.Sdk.PluginRegistration.Entities.msdyn_PostRuleConfigState)(System.Enum.ToObject(typeof(Xrm.Sdk.PluginRegistration.Entities.msdyn_PostRuleConfigState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation> msdyn_postruleconfig_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("msdyn_postruleconfig_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("msdyn_postruleconfig_AsyncOperations");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("msdyn_postruleconfig_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure> msdyn_postruleconfig_BulkDeleteFailures
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("msdyn_postruleconfig_BulkDeleteFailures", null);
			}
			set
			{
				this.OnPropertyChanging("msdyn_postruleconfig_BulkDeleteFailures");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("msdyn_postruleconfig_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.MailboxTrackingFolder> msdyn_postruleconfig_MailboxTrackingFolders
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.MailboxTrackingFolder>("msdyn_postruleconfig_MailboxTrackingFolders", null);
			}
			set
			{
				this.OnPropertyChanging("msdyn_postruleconfig_MailboxTrackingFolders");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.MailboxTrackingFolder>("msdyn_postruleconfig_MailboxTrackingFolders", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.PrincipalObjectAttributeAccess> msdyn_postruleconfig_PrincipalObjectAttributeAccesses
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.PrincipalObjectAttributeAccess>("msdyn_postruleconfig_PrincipalObjectAttributeAccesses", null);
			}
			set
			{
				this.OnPropertyChanging("msdyn_postruleconfig_PrincipalObjectAttributeAccesses");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.PrincipalObjectAttributeAccess>("msdyn_postruleconfig_PrincipalObjectAttributeAccesses", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.ProcessSession> msdyn_postruleconfig_ProcessSession
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.ProcessSession>("msdyn_postruleconfig_ProcessSession", null);
			}
			set
			{
				this.OnPropertyChanging("msdyn_postruleconfig_ProcessSession");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.ProcessSession>("msdyn_postruleconfig_ProcessSession", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.SyncError> msdyn_postruleconfig_SyncErrors
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.SyncError>("msdyn_postruleconfig_SyncErrors", null);
			}
			set
			{
				this.OnPropertyChanging("msdyn_postruleconfig_SyncErrors");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.SyncError>("msdyn_postruleconfig_SyncErrors", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData> msdyn_postruleconfig_UserEntityInstanceDatas
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("msdyn_postruleconfig_UserEntityInstanceDatas", null);
			}
			set
			{
				this.OnPropertyChanging("msdyn_postruleconfig_UserEntityInstanceDatas");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("msdyn_postruleconfig_UserEntityInstanceDatas", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_msdyn_postruleconfig_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_msdyn_postruleconfig_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_msdyn_postruleconfig_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_msdyn_postruleconfig_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_msdyn_postruleconfig_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_msdyn_postruleconfig_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_msdyn_postruleconfig_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_msdyn_postruleconfig_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_msdyn_postruleconfig_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_msdyn_postruleconfig_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_msdyn_postruleconfig_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_msdyn_postruleconfig_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.msdyn_PostConfig msdyn_postconfig_msdyn_postruleconfig
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.msdyn_PostConfig>("msdyn_postconfig_msdyn_postruleconfig", null);
			}
			set
			{
				this.OnPropertyChanging("msdyn_postconfig_msdyn_postruleconfig");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.msdyn_PostConfig>("msdyn_postconfig_msdyn_postruleconfig", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.Organization organization_msdyn_postruleconfig
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("organization_msdyn_postruleconfig", null);
			}
		}
