...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class PluginAssembly : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.PluginType> pluginassembly_plugintype
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.PluginType>("pluginassembly_plugintype", null);
			}
			set
			{
				this.OnPropertyChanging("pluginassembly_plugintype");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.PluginType>("pluginassembly_plugintype", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData> userentityinstancedata_pluginassembly
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_pluginassembly", null);
			}
			set
			{
				this.OnPropertyChanging("userentityinstancedata_pluginassembly");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_pluginassembly", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser createdby_pluginassembly
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("createdby_pluginassembly", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_pluginassembly_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_pluginassembly_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_pluginassembly_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_pluginassembly_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_pluginassembly_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_pluginassembly_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_pluginassembly_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_pluginassembly_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser modifiedby_pluginassembly
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("modifiedby_pluginassembly", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.Organization organization_pluginassembly
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.Organization>("organization_pluginassembly", null);
			}
		}
