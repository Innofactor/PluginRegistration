...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class BulkDeleteOperation : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteOperationState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Xrm.Sdk.PluginRegistration.Entities.BulkDeleteOperationState)(System.Enum.ToObject(typeof(Xrm.Sdk.PluginRegistration.Entities.BulkDeleteOperationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure> BulkDeleteOperation_BulkDeleteFailure
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("BulkDeleteOperation_BulkDeleteFailure", null);
			}
			set
			{
				this.OnPropertyChanging("BulkDeleteOperation_BulkDeleteFailure");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.BulkDeleteFailure>("BulkDeleteOperation_BulkDeleteFailure", null, value);
		...
		public System.Collections.Generic.IEnumerable<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData> userentityinstancedata_bulkdeleteoperation
		{
			get
			{
				return this.GetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_bulkdeleteoperation", null);
			}
			set
			{
				this.OnPropertyChanging("userentityinstancedata_bulkdeleteoperation");
				this.SetRelatedEntities<Xrm.Sdk.PluginRegistration.Entities.UserEntityInstanceData>("userentityinstancedata_bulkdeleteoperation", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.AsyncOperation AsyncOperation_BulkDeleteOperation
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.AsyncOperation>("AsyncOperation_BulkDeleteOperation", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.BusinessUnit BulkDeleteOperation_BusinessUnit
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.BusinessUnit>("BulkDeleteOperation_BusinessUnit", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_bulkdeleteoperation_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_bulkdeleteoperation_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_bulkdeleteoperation_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_bulkdeleteoperation_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_bulkdeleteoperation_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_bulkdeleteoperation_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_bulkdeleteoperation_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_bulkdeleteoperation_modifiedonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_bulkdeleteoperationbase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_bulkdeleteoperationbase_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_bulkdeleteoperationbase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_bulkdeleteoperationbase_modifiedby", null);
			}
		}
