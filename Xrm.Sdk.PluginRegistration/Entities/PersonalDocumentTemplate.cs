...
namespace Xrm.Sdk.PluginRegistration.Entities
{
	...
	public partial class PersonalDocumentTemplate : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Xrm.Sdk.PluginRegistration.Entities.BusinessUnit business_unit_personaldocumenttemplates
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.BusinessUnit>("business_unit_personaldocumenttemplates", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_personaldocumenttemplatebase_createdby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_personaldocumenttemplatebase_createdby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_personaldocumenttemplatebase_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_personaldocumenttemplatebase_createdonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_personaldocumenttemplatebase_createdonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_personaldocumenttemplatebase_createdonbehalfby", null, value);
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_personaldocumenttemplatebase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_personaldocumenttemplatebase_modifiedby", null);
			}
		}
		...
		public Xrm.Sdk.PluginRegistration.Entities.SystemUser lk_personaldocumenttemplatebase_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_personaldocumenttemplatebase_modifiedonbehalfby", null);
			}
			set
			{
				this.OnPropertyChanging("lk_personaldocumenttemplatebase_modifiedonbehalfby");
				this.SetRelatedEntity<Xrm.Sdk.PluginRegistration.Entities.SystemUser>("lk_personaldocumenttemplatebase_modifiedonbehalfby", null, value);
